...
export default {
  name: 'admin-device-home',
  components: {
    PageBoxContainer,
  },
  methods: {
    ...mapActions('admin/device', ['initialize', 'unInitialize']),
    onInvalidParameters() {
  ...
  // Before entering in the admin/device zone,
  // initialize the store admin/device store
  ...
  // uninitialize the store admin/device store
